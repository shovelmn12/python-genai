...
class GroundingPassageId(_common.BaseModel):
...
class GroundingPassageIdDict(TypedDict, total=False):
  """Identifier for a part within a `GroundingPassage`."""
...
GroundingPassageIdOrDict = Union[GroundingPassageId, GroundingPassageIdDict]


class SemanticRetrieverChunk(_common.BaseModel):
...
class SemanticRetrieverChunkDict(TypedDict, total=False):
  """Identifier for a `Chunk` retrieved via Semantic Retriever specified in the `GenerateAnswerRequest` using `SemanticRetrieverConfig`."""
...
SemanticRetrieverChunkOrDict = Union[
    SemanticRetrieverChunk, SemanticRetrieverChunkDict
]


class AttributionSourceId(_common.BaseModel):
  """Identifier for the source contributing to this attribution."""

  grounding_passage: Optional[GroundingPassageId] = Field(
      default=None, description="""Identifier for an inline passage."""
  )
  semantic_retriever_chunk: Optional[SemanticRetrieverChunk] = Field(
      default=None,
      description="""Identifier for a `Chunk` fetched via Semantic Retriever.""",
  )


class AttributionSourceIdDict(TypedDict, total=False):
  """Identifier for the source contributing to this attribution."""

  grounding_passage: Optional[GroundingPassageIdDict]
  """Identifier for an inline passage."""

  semantic_retriever_chunk: Optional[SemanticRetrieverChunkDict]
  """Identifier for a `Chunk` fetched via Semantic Retriever."""


AttributionSourceIdOrDict = Union[AttributionSourceId, AttributionSourceIdDict]
...
class GroundingAttribution(_common.BaseModel):
  ...
  source_id: Optional[AttributionSourceId] = Field(
      default=None,
...
class GroundingAttributionDict(TypedDict, total=False):
  ...
  source_id: Optional[AttributionSourceIdDict]
...
class GenerationConfigThinkingConfig(ThinkingConfig):
  ...
  This field will be deprecated. Please use `ThinkingConfig` instead.
  """
